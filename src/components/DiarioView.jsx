  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div className="df-card">
        <p style={{ margin: "0 0 2px", fontSize: 11.5, color: "var(--ink-soft)", textTransform: "capitalize" }}>Hoje</p>
          ...
          {HUMORES.map((h) => (
            <button
              ...
              style={{
                ...
                background: humor === h.valor ? "var(--blue-pale)" : "var(--white)",
                border: humor === h.valor ? "2px solid var(--blue)" : "1px solid var(--line)",
              }}
            >
              {h.emoji}
            </button>
          ...
          {historico.map((j) => (
            <div key={j.id} className="df-entrada">
              ...
              {(j.horasSono != null || j.coposAgua != null) && (
                <p style={{ margin: "0 0 6px", fontSize: 11.5, color: "var(--ink-soft)", display: "flex", gap: 10 }}>
